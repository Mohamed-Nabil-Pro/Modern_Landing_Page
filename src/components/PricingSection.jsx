    ...
    <section className='py-20 px-4'>
        <div className='max-w-6xl mx-auto'>
            ...
            <div className='max-w-xl mx-auto'>
                <p className='text-gray-600 text-center mb-4'>{productCount} products</p>

                <div className='relative px-4'>
                    <div className='flex items-center gap-2'>
                        <span className='text-xs sm:text-sm text-gray-600'>1</span>
                        <input className='flex-1 h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer' type="range" min={1} max={50} value={productCount} onChange={(e) => setProductCount((e.target.value))} />
